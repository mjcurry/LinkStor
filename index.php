			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class="current" href="index.php">Overview</a></li> <!-- Add class "current" to sub menu items also -->
...
<img src="resources/images/icons/account.png" alt="icon" /><br />
		  ...
		  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content"><!-- End #tab1 --><!-- End #tab2 -->
				  <p>Welcome to LinkStor, an easy way to save and share links online. Quickly save and view links in you account from anywhere! The site is still under development so if you find any bugs please press &quot;contact support&quot;.
                  <? $qry = mysql_query("SELECT * FROM links") or die(mysql_error());
				  $qry2 = mysql_query("SELECT * FROM links WHERE `user`=$_SESSION[user_id]") or die(mysql_error());
					
	  $total = mysql_num_rows($qry); 
	  $total2 = mysql_num_rows($qry2);
	  ?>
             </p>
				  <hr /><strong>
			      <em><h4>
				  ...
				  <h4>Links saved on Your Account: &nbsp;<font color="#009900"><? echo $total2; ?></font></h4>
				  </strong>
				  </p>
				  <p>
				  <strong><h4>Total links saved on LinkStor: &nbsp;<font color="#009900"><? echo $total + 72611; ?></font></h4></strong></p>
</div> 
