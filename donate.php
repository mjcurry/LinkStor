...
<img src="resources/images/icons/account.png" alt="icon" /><br />
		  ...
		  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content"><!-- End #tab1 --><!-- End #tab2 -->
				  <p>LinkStor is an entirely free website. This project relies on donations from <font color="#009900"></font>its loyal users in order to operate. The site grows from the generosity of the people who use it. To help LinkStor maintain fast service please consider clicking the donate button. Your money will allow more space and faster loading times for pages. A donation of any amount of money is welcomed. Thank you for your support -Mike Curry</p>
				  <p><center><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="WHN9A36GF5D6W">
