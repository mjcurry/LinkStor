...
<script type="text/javascript" src="resources/scripts/jquery.date.js"></script>
  ...
  <li>
					...
					<ul>
						...
						<li><a href="support.php" class="current">Account Support</a></li>
					</ul>
				</li>
...
<div class="context-box-content">
    ...
    *************************************************************************/
    ...
    if(isset($_POST['newmessage'])) {
      ...
      if (!$resp->is_valid) {
        ...
        if($pm->sendmessage($sndto,$_POST['subject'],$_POST['message'])) {
            ...
            echo "<div class=\"notification success png_bg\"><div>Message successfully sent, you will be contacted by support shortly.</div></div>";
        } else {
    ...
    <center>
      Use the below form to get support from the site administrator, you will recieve a reply via LinkStor's messaging system. <strong>Please note</strong> that abuse of this form or spamming support will result in instant account termination.</center>
    <p>&nbsp;</p> 
    </p>
