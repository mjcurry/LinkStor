			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class="current" href="about.php">About LinkStor</a></li>
					</ul>
		    </li>
...
<img src="resources/images/icons/account.png" alt="icon" /><br />
		  ...
		  <div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content"><!-- End #tab1 --><!-- End #tab2 -->
				  <p>LinkStor is the easiest way to save links into your own account. You can view the links anywhere you like, just sign into your account. </p>
				  <p>View LinkStor's CSS licence: <a href="simpla-admin-flexible-user-friendly-admin-skin-licence.txt">here</a></p>
