...
Add your MySQL DB credentials into the below config variables

*************************************************************/

define ("DB_HOST", "localhost"); // set database host
define ("DB_USER", "DB_USER"); // set database user
define ("DB_PASS","DB_PASS"); // set database password
...
/*************** reCAPTCHA KEYS****************/
$publickey = "PUBLIC_CAPTCHA";
$privatekey = "PRIVATE_CAPTCHA";
