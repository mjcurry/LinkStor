...
<div class="myaccount">
  ...
  <a href="profile.php">Settings</a><br>
    <a href="logout.php">Logout </a>
	
  <p>Unauthorized access to this page is prohibited and all IP addresses are logged.</p></div>
<?php }
if (checkAdmin()) {
/*******************************END**************************/
?>
...
echo "<div class=\"msg\">User created with password $pwd....done.</div>"; 
      ...
      <p><h2><font color="#FF0000">News:</font></h2></p>
      <?php
// News
...
?>
      <form name="frmcontadd" action="" method="post">
        News Title :
        <input size="41" class="entryfield" name="title" type="text" id="title">
        ...
        <br>
        <br>
        <input class="button" type="submit" name="Submit2" value="Post News">
      </form>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
